...
#define ROTARY_DET_Pin GPIO_PIN_7
#define ROTARY_DET_GPIO_Port GPIOF
#define ROTARY_DET_EXTI_IRQn EXTI9_5_IRQn
#define ROTARY_SW_Pin GPIO_PIN_6
#define ROTARY_SW_GPIO_Port GPIOF
#define ROTARY_SW_EXTI_IRQn EXTI9_5_IRQn
#define BUTTON_BLACK_Pin GPIO_PIN_10
#define BUTTON_BLACK_GPIO_Port GPIOF
#define BUTTON_BLACK_EXTI_IRQn EXTI15_10_IRQn
#define BUTTON_BOTTOM_Pin GPIO_PIN_9
#define BUTTON_BOTTOM_GPIO_Port GPIOF
#define BUTTON_BOTTOM_EXTI_IRQn EXTI9_5_IRQn
#define ROTARY_CW_Pin GPIO_PIN_8
#define ROTARY_CW_GPIO_Port GPIOF
